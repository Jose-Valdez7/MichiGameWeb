    ...
    <div className="min-h-dvh">
      {!isFightIntro && !hideBanner && (
        ...
        <Link to="/" className="flex items-center gap-4 text-5xl md:text-6xl font-black text-white drop-shadow-2xl leading-normal">
          <img src={logoGato} alt="Logo MICHI VIAL" className="w-24 h-24 object-contain" />
          <span className="bg-gradient-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent inline-block">MICHI VIAL</span>
        </Link>
